...
function parser(document) {
    ...
    process.env.NODE_ENV === "production" ? invariant(definitions.length === 1) : invariant(definitions.length === 1, "react-apollo only supports one defintion per HOC. " + document + " had " +
